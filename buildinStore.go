...
type Store interface {
	...
	SetLocation(id string, value *Location)
...
type memoryStore struct {
	sync.RWMutex
	digitsById map[string]*Location
	idByTime   *list.List
...
func NewMemoryStore(collectNum int, expiration time.Duration) Store {
	s := new(memoryStore)
	s.digitsById = make(map[string]*Location)
	s.idByTime = list.New()
...
func (s *memoryStore) SetLocation(id string, value *Location) {
	s.Lock()
...
func (s *memoryStore) GetLocation(id string) (value *Location) {
